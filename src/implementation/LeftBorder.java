...
public class LeftBorder extends Column {
	...
	/**
	 * Im Unterschied zu den uebirgen Faellen, muss leftBorder nicht
	 * ueberpruefen, ob das Konvergenzkriterium erfuellt ist, dass erledigt der
	 * rechte Nachbar.
	 * 
	 * @return immer 0.
	 */
	...
	/**
	 * Berechnet nach jeder lokalen Iteration values neu: value(i) = value(i) +
	 * outRight(i)
	 **/
	@Override
	...
	/**
	 * Da Leftborder keinen linken NAchbarn hat, gibts auch keinen linken Flow
	 * zurueck.
	 * 
	 * @return null.
	 */
	...
	/**
	 * Da Leftborder keinen linken NAchbarn hat, kann hier auch nichts gesetzt
	 * werden.
	 */
	@Override
